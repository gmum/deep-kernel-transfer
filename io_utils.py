...
def parse_args_regression(script):
    ...
    parser.add_argument('--dataset', default='QMUL', help='QMUL / sines / polynomials')
    ...
    parser.add_argument('--context', action='store_true', help='Adding context to polynomials\' task')
